...
local changeLog = {
  ...
  " - Added getter for &Entity&f in &getEntity", --check
  " - Added &bgetNBT&f, &bgetPlayerNBT&f and &bgetEntityNBT&f"
  "   getNBT() -> player",
  "   getNBT( number: entity id ) -> entity ",
  "   getNBT( string: playerName ) -> player ",
  " - 'runners accept bytecode'",
  " - '&ahttpQuick&f for simpler http requests'", --needs more notes
 --require 'json'? luajava Json or lua only?
  "   - buildHTTP( request )",
  "   - httpQuick( url, request )",
  " - 'FileSystem file .readBytes .skipBytes'",
  " - 'inv.setRecipe for recipe book behavior'",
  ...
  " - 'implement logdel' adds ability to remove lines from chat",
  ...
  " - added &b_env() returns AdvancedMacos:_env()", --?? doesn't exist in AM class
  ...
  " - getEntityData, opt second boolean returns luajava of entity",
