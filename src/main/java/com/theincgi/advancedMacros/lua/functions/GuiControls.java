...
//		}
	...
	private static class DoRepair extends VarArgFunction {
		RepairOp op;
		AnvilScreen gr;
		Method renameItem = ObfuscationReflectionHelper.findMethod(AnvilScreen.class, /*"renameItem",*/ "func_214075_a", String.class); //TESTME is this the right func? should be
