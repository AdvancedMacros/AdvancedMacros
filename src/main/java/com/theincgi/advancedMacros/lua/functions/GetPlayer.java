...
public class GetPlayer extends OneArgFunction {
	...
	static {
		...
		playerFunctions.set("lookingAt", 		new PlayerValueFunction("lookingAt", 		player-> {
			RayTraceResult rtr = player.func_213324_a(8, 0, false); //CHECKME
			if(rtr!=null) {
		...
		playerFunctions.set("isActualySwimming",    new PlayerValueFunction("isActualySwimming",player-> {return valueOf(player.isSwimming());}));
